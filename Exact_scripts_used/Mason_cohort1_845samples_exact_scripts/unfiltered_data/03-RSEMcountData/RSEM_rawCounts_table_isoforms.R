...
work_dir="/path/to/processing_scripts/03-RSEMcountData"
counts_dir="/path/to/03-RSEMcountData"
...
write.csv(txi.rsem$counts,file='RSEM_Unnormalized_Isoform_Counts.csv')
